  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-10 left-10 w-32 h-32 border-4 border-indigo-600 animate-rotate-slow"></div>
        <div className="absolute top-1/2 right-20 w-24 h-24 border-4 border-indigo-600 animate-rotate-slow" style={{ animationDirection: 'reverse' }}></div>
        <div className="absolute bottom-20 left-1/3 w-40 h-40 border-4 border-indigo-600 animate-rotate-slow" style={{ animationDuration: '30s' }}></div>
      </div>
      ...
      <div className="w-full max-w-7xl relative z-10">
        ...
        >
          ...
          >
            ...
            <motion.div 
              ...
              className="inline-flex items-center gap-2 bg-indigo-100 text-indigo-900 px-4 py-2 rounded-full text-sm font-medium mb-8 w-fit"
            >
            ...
            <div className="grid grid-cols-2 gap-4 mb-12">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-5 bg-white rounded-2xl border border-gray-200 hover:border-indigo-300 transition-colors duration-300"
                >
            ...
            >
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-8 h-8 bg-indigo-600 rounded-full border-2 border-white"></div>
                ))}
              </div>
          ...
          >
            <div className="relative">
              {/* Decorative Element */}
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-indigo-600 rounded-2xl -z-10"></div>
              <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-indigo-600 rounded-2xl -z-10"></div>
              
              {/* Calendly Container */}
              <div className="bg-white rounded-3xl shadow-xl p-6 relative">
                <div className="mb-6">
                  <h2 className="text-2xl font-bold text-gray-900 mb-2">
                    Book Your <span className="text-indigo-600">Free Session</span>
                  </h2>
        ...
        >
          <div className="inline-flex items-center gap-8">
            <div className="w-16 h-px bg-indigo-600"></div>
