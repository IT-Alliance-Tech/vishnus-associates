...
export const metadata = {
  ...
  description:
    "Vishnu S & Associates is a professional firm offering trusted legal, advisory, and consulting services with a commitment to excellence and client-focused solutions.",
};
